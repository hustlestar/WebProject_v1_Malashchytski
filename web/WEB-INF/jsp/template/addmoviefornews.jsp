...
<body>
<div id="add-movie-for-news" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <form class="form-horizontal" method="post" action="Controller">
                    <input type="hidden" name="command" value="add-movie-for-news"/>
                    <input type="hidden" name="news-id" value="${news.id}"/>
                    <div class="form-group">
                        <label for="inputNickname" class="col-sm-3 control-label">${movieID}</label>
                        <div class="col-sm-7">
                            <input type="number" class="form-control" id="inputNickname" placeholder="${movieID}"
                                   name="id" required>
                        </div>
                    </div>
                    <div class="form-group">

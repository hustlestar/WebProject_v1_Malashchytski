...
/**
 * ViewAllBannedUser class is used to handle client request to
 * show all users, which are banned.
 */
public class ViewAllBannedUser implements Command{
    ...
    private static final Logger logger = LogManager.getLogger(ViewAllBannedUser.class);
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        try {
            users = adminService.getAllBannedUsers();
